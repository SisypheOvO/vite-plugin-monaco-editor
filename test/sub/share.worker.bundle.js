;(() => {
  ...
  var e = class {
    ...
    addEventListener(e2, t, o) {
      return r && e2 !== 'error'
        ? this.ActualWorker?.port.addEventListener(e2, t, o)
        : this.ActualWorker.addEventListener(e2, t, o)
    }
    removeEventListener(e2, t, o) {
      return r && e2 !== 'error'
        ? this.ActualWorker?.port.removeEventListener(e2, t, o)
        : this.ActualWorker.removeEventListener(e2, t, o)
    }
    dispatchEvent(r2) {
