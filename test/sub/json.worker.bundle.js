;(() => {
  ...
  var Emitter = class {
    constructor(options) {
      ...
      this._leakageMon =
        _globalLeakWarningThreshold > 0
          ...
          : void 0
      this._perfMon = ((_a3 = this._options) === null || _a3 === void 0 ? void 0 : _a3._profName)
    ...
    dispose() {
      ...
      if (!this._disposed) {
        ...
        ;(_c =
          (_b = this._options) === null || _b === void 0 ? void 0 : _b.onLastListenerRemove) ===
          null || _c === void 0
          ? void 0
          : _c.call(_b)
    ...
    get event() {
      if (!this._event) {
        this._event = (callback, thisArgs, disposables) => {
          ...
          if (
            firstListener &&
            ((_a3 = this._options) === null || _a3 === void 0 ? void 0 : _a3.onFirstListenerAdd)
          ) {
          ...
          if (
            firstListener &&
            ((_b = this._options) === null || _b === void 0 ? void 0 : _b.onFirstListenerDidAdd)
          ) {
    ...
    fire(event) {
      ...
      if (this._listeners) {
        ...
        ;(_a3 = this._perfMon) === null || _a3 === void 0
          ? void 0
          : _a3.start(this._deliveryQueue.size)
  ...
  var Range = class {
    ...
    static equalsRange(a2, b) {
      return (
        !!a2 &&
        !!b &&
        a2.startLineNumber === b.startLineNumber &&
        a2.startColumn === b.startColumn &&
        a2.endLineNumber === b.endLineNumber &&
  ...
  var Selection = class extends Range {
    ...
    static selectionsEqual(a2, b) {
      return (
        a2.selectionStartLineNumber === b.selectionStartLineNumber &&
  ...
  ;(function (CSSIcon2) {
    ...
    const cssIconIdRegex = new RegExp(
      `^(${CSSIcon2.iconNameExpression})(${CSSIcon2.iconModifierExpression})?$`
    )
  ...
  ;(function (EditorOption2) {
    ...
    EditorOption2[(EditorOption2['unfoldOnClickAfterEndOfLine'] = 42)] =
    ...
    EditorOption2[(EditorOption2['mouseWheelScrollSensitivity'] = 67)] =
      'mouseWheelScrollSensitivity'
    EditorOption2[(EditorOption2['mouseWheelZoom'] = 68)] = 'mouseWheelZoom'
    EditorOption2[(EditorOption2['multiCursorMergeOverlapping'] = 69)] =
    ...
    EditorOption2[(EditorOption2['renderLineHighlightOnlyWhenFocus'] = 86)] =
      'renderLineHighlightOnlyWhenFocus'
    EditorOption2[(EditorOption2['renderValidationDecorations'] = 87)] =
      'renderValidationDecorations'
    EditorOption2[(EditorOption2['renderWhitespace'] = 88)] = 'renderWhitespace'
    EditorOption2[(EditorOption2['revealHorizontalRightPadding'] = 89)] =
    ...
    EditorOption2[(EditorOption2['suggestOnTriggerCharacters'] = 109)] =
    ...
    EditorOption2[(EditorOption2['wordWrapBreakAfterCharacters'] = 119)] =
      'wordWrapBreakAfterCharacters'
    EditorOption2[(EditorOption2['wordWrapBreakBeforeCharacters'] = 120)] =
      ...
      switch (reason) {
        ...
        case 3: {
          ...
          const notAmbiguousInLocales = AmbiguousCharacters.getLocales().filter(
            (l) =>
              !AmbiguousCharacters.getInstance(new Set([...options.allowedLocales, l])).isAmbiguous(
                codePoint
              )
          )
          return {
  ...
  var EditorSimpleWorker = class {
    ...
    computeDiff(originalUrl, modifiedUrl, ignoreTrimWhitespace, maxComputationTime) {
      return __awaiter2(this, void 0, void 0, function* () {
        ...
        const identical =
          diffResult.changes.length > 0 ? false : this._modelsAreIdentical(original, modified)
        return {
  ...
  ;(function (Range22) {
    ...
    function is(value) {
      var candidate = value
      return (
        Is.objectLiteral(candidate) && Position2.is(candidate.start) && Position2.is(candidate.end)
      )
    }
    Range22.is = is
  })(Range2 || (Range2 = {}))
    ...
    function is(value) {
      ...
      return (
        ...
        (Is.undefined(candidate.codeDescription) ||
          Is.string(
            (_a3 = candidate.codeDescription) === null || _a3 === void 0 ? void 0 : _a3.href
          )) &&
  ...
  ;(function (TextEdit2) {
    ...
    function is(value) {
      var candidate = value
      return (
        Is.objectLiteral(candidate) && Is.string(candidate.newText) && Range2.is(candidate.range)
      )
    }
    TextEdit2.is = is
  })(TextEdit || (TextEdit = {}))
  ...
  ;(function (CodeLens2) {
    ...
    function is(value) {
      ...
      return (
        Is.defined(candidate) &&
        Range2.is(candidate.range) &&
        (Is.undefined(candidate.command) || Command2.is(candidate.command))
      )
    }
    CodeLens2.is = is
  })(CodeLens || (CodeLens = {}))
      ...
      if (this.root && schema2) {
        ...
        return validationResult.problems.map(function (p) {
          ...
          return Diagnostic.create(
            range,
            p.message,
            (_a3 = p.severity) !== null && _a3 !== void 0 ? _a3 : severity,
            p.code
          )
        })
      }
      ...
      if (Array.isArray(schema2.type)) {
        ...
        if (!matchesType(schema2.type)) {
          validationResult.problems.push({
            ...
            message:
              schema2.errorMessage ||
              localize2('typeMismatchWarning', 'Incorrect type. Expected "{0}".', schema2.type),
          })
        }
      }
      ...
      if (isDefined(schema2.const)) {
        ...
        if (!equals2(val, schema2.const)) {
          validationResult.problems.push({
            ...
            message:
              schema2.errorMessage ||
              localize2('constWarning', 'Value must be {0}.', JSON.stringify(schema2.const)),
          })
      ...
      function normalizeFloats(float) {
        ...
        return (
          parts && {
            ...
            multiplier:
              (((_a3 = parts[2]) === null || _a3 === void 0 ? void 0 : _a3.length) || 0) -
              (parseInt(parts[3]) || 0),
          }
        )
      }
          ...
          case 'ipv6':
            ...
            if (!node2.value || !format4.pattern.exec(node2.value)) {
              validationResult2.problems.push({
                location: { offset: node2.offset, length: node2.length },
                message:
                  schema22.patternErrorMessage || schema22.errorMessage || format4.errorMessage,
              })
            }
          default:
        }
          ...
          if (s.node === node && !s.inverted && s.schema) {
            ...
            if (parentKey !== void 0) {
              ...
              if (s.schema.patternProperties && !propertyMatched) {
                for (
                  var _a3 = 0, _b = Object.keys(s.schema.patternProperties);
                  _a3 < _b.length;
                  _a3++
                ) {
                  var pattern = _b[_a3]
          ...
          var n = {
            resolve: function () {
              for (var t3, n2 = '', o = false, i = arguments.length - 1; i >= -1 && !o; i--) {
                var a2
                ;(i >= 0 ? (a2 = arguments[i]) : (t3 === void 0 && (t3 = process.cwd()), (a2 = t3)),
                  e2(a2),
                  a2.length !== 0 && ((n2 = a2 + '/' + n2), (o = a2.charCodeAt(0) === 47)))
              }
              return (
                (n2 = r2(n2, !o)),
            ...
            relative: function (t3, r3) {
              ...
              var p = ''
              for (u = o + f2 + 1; u <= i; ++u)
                (u !== i && t3.charCodeAt(u) !== 47) ||
                  (p.length === 0 ? (p += '..') : (p += '/..'))
              return p.length > 0
                ? p + r3.slice(h + f2)
                : ((h += f2), r3.charCodeAt(h) === 47 && ++h, r3.slice(h))
            },
            ...
            dirname: function (t3) {
              if ((e2(t3), t3.length === 0)) return '.'
              for (
                var r3 = t3.charCodeAt(0), n2 = r3 === 47, o = -1, i = true, a2 = t3.length - 1;
                a2 >= 1;
                --a2
              )
              ...
              if (r3 !== void 0 && r3.length > 0 && r3.length <= t3.length) {
                ...
                for (n2 = t3.length - 1; n2 >= 0; --n2) {
                  ...
                  if (c === 47) {
                    ...
                    (s === -1 && ((a2 = false), (s = n2 + 1)),
                      h >= 0 &&
                        (c === r3.charCodeAt(h) ? --h == -1 && (i = n2) : ((h = -1), (i = s))))
                }
            ...
            parse: function (t3) {
              ...
              for (var a2 = -1, h = 0, s = -1, c = true, f2 = t3.length - 1, u = 0; f2 >= n2; --f2)
                if ((o = t3.charCodeAt(f2)) !== 47)
                  (s === -1 && ((c = false), (s = f2 + 1)),
                    o === 46 ? (a2 === -1 ? (a2 = f2) : u !== 1 && (u = 1)) : a2 !== -1 && (u = -1))
                else if (!c) {
                  h = f2 + 1
                  break
                }
              return (
                a2 === -1 || s === -1 || u === 0 || (u === 1 && a2 === s - 1 && a2 === h + 1)
                  ? s !== -1 && (r3.base = r3.name = h === 0 && i ? t3.slice(1, s) : t3.slice(h, s))
                  : (h === 0 && i
        ...
        447: (t2, e2, r2) => {
          ...
          var i,
            ...
            h =
              ...
              function (t3, e3) {
                ...
                ;(i(t3, e3),
                  (t3.prototype =
                    e3 === null ? Object.create(e3) : ((r3.prototype = e3.prototype), new r3())))
              }),
            s = /^\w[\w\d+.-]*$/,
            c = /^\//,
            f2 = /^\/\//
              ...
              return (
                (t3.isUri = function (e3) {
                  return (
                    e3 instanceof t3 ||
                    (!!e3 &&
                      typeof e3.authority == 'string' &&
                      typeof e3.fragment == 'string' &&
                      typeof e3.path == 'string' &&
                      typeof e3.query == 'string' &&
                      typeof e3.scheme == 'string' &&
                      typeof e3.fsPath == 'string' &&
                ...
                (t3.prototype.with = function (t4) {
                  ...
                  var e3 = t4.scheme,
                    ...
                    i2 = t4.fragment
                  return (
                    e3 === void 0 ? (e3 = this.scheme) : e3 === null && (e3 = l),
                    r3 === void 0 ? (r3 = this.authority) : r3 === null && (r3 = l),
                    n2 === void 0 ? (n2 = this.path) : n2 === null && (n2 = l),
                    o2 === void 0 ? (o2 = this.query) : o2 === null && (o2 = l),
                    i2 === void 0 ? (i2 = this.fragment) : i2 === null && (i2 = l),
                    e3 === this.scheme &&
                    r3 === this.authority &&
                    n2 === this.path &&
                    o2 === this.query &&
          ...
          function b(t3, e3) {
            for (var r3 = void 0, n2 = -1, o2 = 0; o2 < t3.length; o2++) {
              ...
              if (
                ...
                (n2 !== -1 && ((r3 += encodeURIComponent(t3.substring(n2, o2))), (n2 = -1)),
            ...
            return (
              n2 !== -1 && (r3 += encodeURIComponent(t3.substring(n2))),
              r3 !== void 0 ? r3 : t3
            )
          }
          function C(t3) {
          ...
          function w(t3, e3) {
            var r3 = e3 ? C : b,
              ...
              s2 = t3.fragment
            if (
              (o2 && ((n2 += o2), (n2 += ':')), (i2 || o2 === 'file') && ((n2 += p), (n2 += p)), i2)
            ) {
              var c2 = i2.indexOf('@')
              if (c2 !== -1) {
              ...
              ;(c2 = (i2 = i2.toLowerCase()).indexOf(':')) === -1
                ? (n2 += r3(i2, false))
  ...
  function findLinks(document, doc) {
    ...
    doc.visit(function (node) {
      ...
      if (
        ...
        ((_a3 = node.valueNode) === null || _a3 === void 0 ? void 0 : _a3.type) === 'string'
      ) {
      ...
      format: function (d, r, o) {
        ...
        return format2(d.getText(), range, options).map(function (e) {
          return TextEdit.replace(
            Range2.create(d.positionAt(e.offset), d.positionAt(e.offset + e.length)),
            e.content
          )
        })
      },
